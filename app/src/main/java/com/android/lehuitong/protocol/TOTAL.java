...
public class TOTAL  extends Model
{
     ...
     @Column(name = "amount_fomated")
     public String amount_fomated;
 ...
 public static TOTAL fromJson(JSONObject jsonObject)  throws JSONException
 {
     ...
     localItem.amount_fomated=jsonObject.optString("amount_formated");
 ...
 public JSONObject  toJson() throws JSONException 
 {
     ...
     localItemObject.put("amount_fomated", amount_fomated);
