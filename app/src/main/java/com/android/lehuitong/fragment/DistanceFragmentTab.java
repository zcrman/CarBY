...
public class DistanceFragmentTab extends BaseFragment implements BusinessResponse{
	...
	public DistanceFragmentTab(int type,String detail) {
		this.type=type;
		this.detail=detail;
	}
	public DistanceFragmentTab(){}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		android.util.Log.i("lat", ""+position.lat);
		android.util.Log.i("lon", ""+position.lon);
		sellerModel.getSellerList(type+"","distance",detail,BeeFrameworkApp.getInstance().lng, BeeFrameworkApp.getInstance().lat);
		return view;
	}
